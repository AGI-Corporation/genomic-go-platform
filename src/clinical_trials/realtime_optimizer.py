...
class SafetyMonitoringSystem:
    ...
    def __init__(self, trial_id: str, safety_threshold: float = 0.15):
        ...
        # Store (timestamp_dt, event_dict) to avoid redundant parsing
    ...
    async def process_adverse_event(self, event: Dict):
        ...
        # Ensure timestamp is UTC-aware and parsed once
        try:
        ...
        # O(1) amortized sliding window pruning (assuming mostly chronological events)
        ...
        if buffer_size > 10:  # Minimum for statistical power
            ...
            if severe_ae_rate > self.safety_threshold:
                # API expects List[Dict], extract from our (dt, dict) tuples
