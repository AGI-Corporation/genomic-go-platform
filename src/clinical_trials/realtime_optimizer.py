...
class SafetyMonitoringSystem:
    ...
    async def process_adverse_event(self, event: Dict):
        ...
        # BOLT OPTIMIZATION: Use sliding window with O(1) amortized complexity
        # and O(1) severe event tracking to avoid O(N) buffer scans.
        ...
        if len(self.ae_buffer) > 10:  # Minimum for statistical power
            ...
            if severe_ae_rate > self.safety_threshold:
                # Convert back to list of dicts for compatibility with alert system
